...
<body>
                    ...
                    <div class="Register_backLink__0L3KX">
                      ...
                      <p>Already a client?<button class="Button_button__mNI1O Button_text__HE4Yz"
                          style="text-decoration: underline; padding: 0px; margin-left: 3px;"><a
                            href="<?php echo sysfunc::url( __users_login_page ); ?>">Log in here</a></button></p>
                    </div>
                  </div>
                </form>
              </div>
  ...
  <script id="__NEXT_DATA__"
    type="application/json">{"props":{"pageProps":{}},"page":"/auth/register-live","query":{},"buildId":"tNrQdIk_M6r-x_00Kt5xG","nextExport":true,"autoExport":true,"isFallback":false,"scriptLoader":[]}</script>
</body>
