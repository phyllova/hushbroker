                    ...
                    <div class='card-body'>
                        ...
                        <form  action="<?php echo sysfunc::sanitize_input($_SERVER["PHP_SELF"]);?>" method="POST">
                            ...
                            <div class="form-outline mb-3">
                                ...
                                <span class="help-block text-danger small"><?php  ?></span>
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class='form-check-label'>By signing up I confirm I accept the <a href='javascript:void(0)'>terms of use</a>, and consent to the processing of my personal and biometric data as stated in the privacy policy.</label>
                                </br>      
                            </div>
