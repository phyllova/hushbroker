...
INSERT INTO `users` (`id`, `username`, `firstname`, `lastname`, `fullname`, `email`, `password`, `confirm`, `token`, `refcode`, `image`, `verify`, `ver_image`, `session`, `referred`, `refbonus`, `walletbalance`, `pm`, `eth`, `bank`, `accno`, `accname`, `swiftcode`, `btc`, `usdt`, `2fa`, `date`, `phone`, `address`, `country`) VALUES
(198, 'wchloe7964', 'Chloe', 'Wilson', 'Chloe Wilson', 'wchloe7964@gmail.com', 'G123456', 1, '5l#bhoMPS2', 'eWU6t0kHXE', NULL, 1, NULL, 0, '', 0, 43970, '', '', 'Alli Pay', '82651344265', 'Chloe Wilson', '', 'yu7i38uij3893y33yusgdhgsftdfa', '', 0, '2023-09-15 10:56:24', '4703444037', '111 Jackson St', 'US');
